...
$path_query_all = "../goral_bike_layout/goral_biker_off_product.php";
...
<div class="container my-5">
    ...
    <div class="row justify-content-end">
        <div class="py-2 text-end ">
            ...
            <div>
                <a class="btn btn-dark" href="<?= $path_query_all ?>">所有商品</a>
    ...
    <form action="../product/goral_bike_php/product_select_on_product.php" method="post">
        <div class="row mt-2">
            <div class="row justify-content-end align-items-center gap-3">
                ...
                <button class="btn col-2 my-3 btn-danger" type="submit" formaction="../product/goral_bike_php/product_select_DELETE_ALL.php">批次商品移除</button>
            </div>
