    ...
    <form action="../product/goral_bike_php/product_select_on_product.php" method="post">
        <div class="row mt-2">
            ...
            <div class="row justify-content-end align-items-center mt-5">
                <h2 class="h2 col-12 text-center">下架商品列表</h2>
                <p class="col-12 text-end m-0">今日日期：<?= $today ?></p>
                <input class="btn col-2 my-3 mx-1 btn-dark" type="button" value="全部選取" onclick="usel();">
                <button class="btn col-2 my-3 mx-1 btn-primary" type="submit">批次上架</button>
                <button class="btn col-2 my-3 mx-1 btn-danger" type="submit" formaction="../product/goral_bike_php/product_select_DELETE_ALL.php">批次商品移除</button>
            </div>
