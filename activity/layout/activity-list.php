            ...
            <div class="row g-0">
                ...
                <div class="col-6 ">
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            <h5 class="card-text">
                                <span class="badge <?php if ($row["activity_venue_id"] == 1) : echo "bg-danger" ?>
                                    ...
                                    <?php endif; ?> 
                                    rounded-pill px-2 me-1" <?php if (!$row["activity_venue_id"]) : echo "hidden" ?>
                                    <?php endif; ?>>
                            ...
                            <h5 class="card-text">
                                <span class="badge <?php if ($row["activity_status_id"] == 1) : echo "bg-secondary" ?>
                                    ...
                                    <?php endif; ?> 
                                    rounded-pill px-2 me-1" <?php if (!$row["activity_status_id"]) : echo "hidden" ?>
                                    <?php endif; ?>>
                        ...
                        <p class="card-text activity_cont"><small
                                class="text-muted"><?= $row["activity_content"] ?></small></p>
                    </div>
<<<<<<< HEAD
                    <!-- ================= 修改 ================= -->
                    <div class="col-3 ">
...
=======
                ...
                <div class="col-3 ">
                    ...
                    <a class="btn btn-outline-success mx-1"
                        href="goral_biker_activity-upload.php?id=<?= $row["id"] ?>&status=<?= $row["activity_status_id"] ?>&venue=<?= $row["activity_venue_id"] ?>">編輯</a>
                    <a href="#" class="btn btn-outline-warning mx-1">下架</a>
                    <a href="#" class="btn btn-outline-danger mx-1">刪除</a>
>>>>>>> edf74d44929e8697ccda2f58507dfbf9ee3a1173
                </div>
            </div>
        </div>
        <?php endforeach; ?>
        ...
        <div class="d-flex justify-content-center">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    <?php endif; ?>
                    <li class="page-item">
                        <a class="page-link" href="goral_biker_activity-list.php?p=<?= $page_count ?>"
                            aria-label="Next">
