    ...
    <div class="container mb-5">
        <div class="py-2">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a href="./course-list.php?valid=1&p=1&type=<?=$type?>"
                        class="nav-link <?php if(!isset($_GET["valid"]) ||$_GET["valid"]==1): echo "active"?><?php endif;?>"
                        aria-current="page">已上架商品</a>
                </li>
                <li class="nav-item">
                    <a href="./course-list.php?valid=0&p=1&type=<?=$type?>"
                        class="nav-link <?php if(isset($_GET["valid"]) &&$_GET["valid"]==0): echo "active"?><?php endif;?>"
                        aria-current="page">已下架商品</a>
                </li>
            </ul>
        </div>
